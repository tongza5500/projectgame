...
Hard.prototype = proto;
Hard.prototype.constructor = Easy;



Hard.prototype.create = function() {
...
Hard.prototype.createfood = function() {
...
Hard.prototype.useLpop = function()	{
		//Pop Up
...
Hard.prototype.useWpop = function()	{
		//Pop Up
...
Hard.prototype.openLWindow = function() { 
...
//creater monster
Hard.prototype.createfly = function() {
...
Hard.prototype.createdish = function() {
	this.dishs = this.add.group(this.game.world,'key',false,true,
		...
		//Crash spider
Hard.prototype.ondishCollide = function(food,dishs){
			//smoke
...
//################################################################################		
//food Was Killed
Hard.prototype.onfoodKilled = function(food){
	//smoke and foodSound
...
//Crash spider
Hard.prototype.onfoodCollide = function(food,fly){
	//smoke
...
Hard.prototype.quitGame=function(){
	this.music.destroy();
